...
var api = {
    ...
    //新增请求
    ext:{
      qrcode: _api_root + "user/qrcode",
      search_goods: _api_root + "default/search-goods",
      search_hot : _api_root + "default/search-hot",
      goods_store: _api_root + "default/goods-store",
      goods_detail: _api_root + "default/goods-detail",
      get_store: _api_root + "default/nearby",
      get_promotion: _api_root + "promotion/info",
      switch_shop: _api_root + "default/switch-shop",
      save_user: _api_root + "user/save",
      get_fund: _api_root + "default/look-fund",
      submit_fund: _api_root +"default/commit-look-fund",
      upload: _api_root +"default/upload",
      update_phone: _api_root + "user/update-phone",
      get_sms: _api_root + "user/get-sms",
      shop_cat: _api_root +"default/shop-cat",
      shop_goods: _api_root +"default/shop-goods",
      order_detail: _api_root +"order/cancel-detail",
      promotion_set: _api_root +"default/promotion-set",
      mock_login: _api_root +"user/mock-login",
      binding_employee: _api_root + "user/binding-employee"
    }
};
